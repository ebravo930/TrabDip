...
#         elif not habitacionexiste:
#             # si la habitacionexiste y tiene capacidadhabitacion

#             # insertamos una nueva cama 
#             idHabitacion = obtener_id_habitacion(l.GetHabitacion())
#             query = "INSERT INTO Cama (habitacionid, disponibilidad) VALUES(%s,%s);"
#             cursor.execute(query, (idHabitacion, True,))
#             print("---------------------DESTINO--------------------", idHabitacion)
#             if cursor.rowcount > 0:

#                 # liberar capacidad Habitacion origen
#                 idhaboigen = obtener_id_habitacion(l.GetHabitacion_origen())

#                 print("---------------------ORIGEN--------------------", idhaboigen)
...
#                         SELECT camaid 
#                         FROM cama 
#                         WHERE habitacionid = %s 
#                         ORDER BY camaid DESC 
#                         LIMIT 1 
#                         ) 
#                  """
#                 cursor.execute(query2, (idhaboigen))

#                 if cursor.rowcount > 0:
#                     print("La habitacion se movio con exito ")
#                 else:
#                     print("No se pudo eliminar la cama ")
#             else:
#                 print("Error mover la cama")
